...
public class ExtentReportManager {
	...
	public static void startReport()
	{
		...
		spark = new ExtentSparkReporter(System.getProperty("user.dir")+"/reports/"+dateStamp+"/"+"C-Zentrix-"+timeStamp+".html");
...
*/	
		...
		spark.config().setDocumentTitle("C-Zentrix_html_Report");
		spark.config().setReportName("C-Zentrix_html_Report");
